...
!        write(output,*) l1(il),m1(il),l2(il),m2(il),l(il)
           READ(ipot,*) fi(0:nmax,il)
...
!
!**********************************************************************************
!  fi=fi*(2.d0*mu)*6.2709d2!/uacmm1
  fi=fi*(2.d0*mu)*3.4999d2/uacmm1
!**********************************************************************************
!
