...
!$ use omp_lib
  ...
  real(kind=dp),allocatable, dimension(:,:) :: vec1,vvv
...
!
!**********************************************************************************
!  drr=(pi/dsqrt(E*(2.d0*mu)/uacmm1))/dfloat(npas*2)
  drr=(pi/dsqrt(ktab(1)))/dfloat(npas*2)
